...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-navy-800/50 [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      "transform-gpu",
      className,
    )}
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      <Icon className="h-12 w-12 origin-left transform-gpu text-slate-300 transition-all duration-300 ease-in-out group-hover:scale-75" />
