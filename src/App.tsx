...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-navy-950 via-navy-900 to-navy-950 overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8c7ebb12_1px,transparent_1px),linear-gradient(to_bottom,#8c7ebb12_1px,transparent_1px)] bg-[size:32px_32px]"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-lavender-700/5 to-transparent"></div>

      <GradientDots className="absolute top-0 left-0 w-full h-full opacity-30" />

      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-lavender-600/30 bg-lavender-700/10 px-5 py-2.5 text-sm font-semibold text-lavender-400 mb-8 backdrop-blur-sm">
          <Globe size={16} />
          Teacher Talent Intelligence Database
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-8 leading-[1.1]">
        ...
        <button
          ...
          className="group inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-lavender-600 to-lavender-700 px-8 py-4 text-lg font-semibold text-white shadow-2xl shadow-lavender-700/30 transition-all hover:shadow-xl hover:shadow-lavender-700/40 hover:scale-105"
        >
          Know More
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-lavender-600/50 rounded-full flex items-start justify-center p-2">
          <div className="w-1 h-3 bg-lavender-600/50 rounded-full"></div>
        </div>
      </div>
    </section>
  );
        ...
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-2 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-navy-800 leading-[1.1]">
            ...
            <div className="space-y-4 text-lg text-slate-600 leading-relaxed">
              <p>
                Teacheristic is building a <strong className="text-navy-800">Teacher Talent Intelligence Database</strong> to help educators become visible, validated, and career-aligned for emerging opportunities.
              </p>
            </div>

            <div className="relative rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-300 p-6 sm:p-8">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-amber-400/30 to-transparent rounded-full blur-3xl"></div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="rounded-2xl bg-gradient-to-br from-lavender-100 to-lavender-50 p-6 shadow-lg transform hover:scale-105 transition-transform">
                  <Globe className="w-12 h-12 text-lavender-700 mb-3" />
                  <h4 className="font-bold text-navy-800 mb-2">Global Reach</h4>
                  <p className="text-sm text-slate-600">Connect with schools worldwide</p>
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 p-6 shadow-lg transform hover:scale-105 transition-transform">
                  <UserCheck className="w-12 h-12 text-blue-700 mb-3" />
                  <h4 className="font-bold text-navy-800 mb-2">Validated Profiles</h4>
                  <p className="text-sm text-slate-600">ATS-reviewed resumes and profiles</p>
                </div>
              </div>
              <div className="space-y-4 mt-8">
                <div className="rounded-2xl bg-gradient-to-br from-green-100 to-green-50 p-6 shadow-lg transform hover:scale-105 transition-transform">
                  <TrendingUp className="w-12 h-12 text-green-700 mb-3" />
                  <h4 className="font-bold text-navy-800 mb-2">Career Growth</h4>
                  <p className="text-sm text-slate-600">Intelligence-driven guidance</p>
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-purple-100 to-purple-50 p-6 shadow-lg transform hover:scale-105 transition-transform">
                  <Rocket className="w-12 h-12 text-purple-700 mb-3" />
                  <h4 className="font-bold text-navy-800 mb-2">Priority Access</h4>
...
const ValueSection: React.FC = () => {
  ...
  return (
    <section id="value" className="relative bg-gradient-to-b from-slate-50 to-white py-16 sm:py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit, idx) => (
            <div
              key={idx}
              className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-lg transition-all hover:shadow-2xl hover:scale-105 hover:border-lavender-300"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-lavender-400/20 to-transparent rounded-full blur-3xl opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="relative space-y-4">
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-lavender-600 to-lavender-700 flex items-center justify-center shadow-lg">
                    <benefit.icon className="w-6 h-6 text-white" />
                  </div>
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-lavender-100 flex items-center justify-center">
                    <span className="text-sm font-bold text-lavender-800">{idx + 1}</span>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-navy-800 leading-tight">
                  {benefit.title}
                </h3>
...
const QualificationSection: React.FC = () => {
  ...
  return (
    <section id="qualification" className="relative bg-white py-16 sm:py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 max-w-3xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-green-200 px-4 py-2 text-sm font-semibold text-green-900">
            <UserCheck size={16} />
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-12">
          {qualifications.map((qual, idx) => (
            <div
              key={idx}
              className="group relative overflow-hidden rounded-2xl border-2 border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6 sm:p-8 shadow-lg transition-all hover:shadow-2xl hover:scale-105 hover:border-green-300"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-400/20 to-transparent rounded-full blur-3xl opacity-0 transition-opacity group-hover:opacity-100"></div>
              <div className="relative space-y-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-green-600 to-green-700 flex items-center justify-center shadow-lg">
        ...
        <div className="max-w-4xl mx-auto rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 p-8 sm:p-10 text-center">
...
const RegisterSection: React.FC<RegisterSectionProps> = ({ onTeacherClick, onSchoolClick }) => {
  return (
    <section id="register" className="relative overflow-hidden bg-gradient-to-br from-navy-950 via-navy-900 to-navy-950 py-20 sm:py-24 md:py-32">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8c7ebb12_1px,transparent_1px),linear-gradient(to_bottom,#8c7ebb12_1px,transparent_1px)] bg-[size:32px_32px]"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-lavender-700/5 to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 max-w-3xl mx-auto text-center space-y-4">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white leading-[1.1]">
            Take the First Step Toward a <span className="bg-gradient-to-r from-lavender-400 to-lavender-600 bg-clip-text text-transparent">Stronger Teaching Career</span>
          </h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
          <div className="group relative overflow-hidden rounded-3xl border-2 border-lavender-600/30 bg-gradient-to-br from-navy-900/90 to-navy-950/90 p-8 sm:p-10 backdrop-blur-xl shadow-2xl transition-all hover:border-lavender-600/50 hover:scale-105">
            ...
            <div className="relative space-y-6">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-lavender-600 to-lavender-700 shadow-lg">
              ...
              <button
                ...
                className="group w-full rounded-xl bg-gradient-to-r from-lavender-600 to-lavender-700 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2"
              >
          ...
          <div className="group relative overflow-hidden rounded-3xl border-2 border-slate-700/50 bg-gradient-to-br from-slate-900/90 to-slate-950/90 p-8 sm:p-10 backdrop-blur-xl shadow-2xl transition-all hover:border-slate-600/50 hover:scale-105">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-700/20 to-transparent rounded-full blur-3xl"></div>
            <div className="relative space-y-6">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-800 shadow-lg">
              ...
              <button
                ...
                className="group w-full rounded-xl border-2 border-slate-700 bg-slate-900/50 px-8 py-4 text-lg font-semibold text-white transition-all hover:border-slate-600 hover:bg-slate-900/70 hover:scale-105 flex items-center justify-center gap-2"
              >
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#about" className="hover:text-lavender-600 transition-colors">About Initiative</a></li>
              <li><a href="#value" className="hover:text-lavender-600 transition-colors">What You Get</a></li>
              <li><a href="#qualification" className="hover:text-lavender-600 transition-colors">Who Should Join</a></li>
              <li><a href="#register" className="hover:text-lavender-600 transition-colors">Register Now</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#register" className="hover:text-lavender-600 transition-colors">Teacher Registration</a></li>
              <li><a href="#register" className="hover:text-lavender-600 transition-colors">School Partnership</a></li>
              <li><Link to="/students" className="hover:text-lavender-600 transition-colors">Student Database</Link></li>
              <li><a href="#value" className="hover:text-lavender-600 transition-colors">Career Intelligence</a></li>
            </ul>
          </div>
